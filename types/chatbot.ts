...
export interface QuotationData {
  ...
  habitaciones_adicionales_summary: string // For additional bedrooms
  espacios_adicionales_summary: string // For other extra spaces
  m2_formatted: string // Total area formatted with "m²"
